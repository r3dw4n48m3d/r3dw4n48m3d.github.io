        ...
        <div className="pt-24 pb-16 px-4 max-w-6xl mx-auto">
          ...
          <div className="text-center mb-16">
            <div className="inline-block mb-4">
              ...
              <span className="text-cyan-400 font-mono text-sm ml-2 animate-pulse">
                ls -la
              </span>
            </div>
            ...
            <p className="text-green-600 max-w-2xl mx-auto font-mono">
              Write-ups, tutorials, and security research findings from my
          ...
          <div className="mb-12">
            <div className="flex flex-col md:flex-row gap-4 items-center justify-between">
              ...
              <div className="flex gap-2 flex-wrap justify-center">
                {["All", "Write-ups", "Tutorials", "Research", "CTF"].map(
                  (tag) => (
                    <button
                      key={tag}
