...
export default function ContactForm() {
  ...
  // ⚠️ Inline key (NOT secure for production)
  const WEB3FORMS_ACCESS_KEY = "09ff3df8-5517-4c18-9680-beb3e6a87b84"; // It's not that what you think
  ...
  const onSubmit = async (event: FormEvent<HTMLFormElement>) => {
    ...
    try {
      ...
      setResult("Something went wrong ⚠️");
    }
  };
  ...
  const socialLinks = [
    {
      name: "GitHub",
      url: "https://github.com/r3dw4n48m3d",
      icon: (
    ...
    {
      name: "LinkedIn",
      url: "https://linkedin.com/ in/r3dw4n-48m3d",
      icon: (
        <svg className="w-6 h-6" fill="currentColor" viewBox="0 0 24 24">
    ...
    {
      name: "Twitter",
      url: "https://twitter.com/r3dw4n48m3d",
      icon: (
        <svg className="w-6 h-6" fill="currentColor" viewBox="0 0 24 24">
    ...
    {
      name: "HackerOne",
      url: "https://hackerone.com/r3dw4n",
      icon: (
        <svg className="w-6 h-6" fill="currentColor" viewBox="0 0 24 24">
              ...
              <div className="font-mono text-sm space-y-4">
                ...
                <div className="space-y-3 text-green-400">
                  <p>
                    ...
                    redwanahmedridoy2005@gmail.com
                  </p>
                  <p>
                  ...
                  <p>
                    <span className="text-cyan-400">🕐 Timezone:</span> UTC+6
                    (Flexible)
                  </p>
                  <p>
          ...
          <form onSubmit={onSubmit} className="space-y-6">
            <div className="grid sm:grid-cols-2 gap-4">
              <input
                ...
                required
                className="w-full bg-black/60 border border-green-900/50 rounded-lg px-4 py-3 text-green-400"
              />
            ...
            <textarea
              ...
              required
              className="w-full bg-black/60 border border-green-900/50 rounded-lg px-4 py-3 text-green-400 resize-none"
            />

            <button
              type="submit"
              className="w-full py-4 bg-gradient-to-r from-green-600 to-cyan-600 rounded-lg text-black font-bold"
            >
              Send Message
            </button>

            {/* Result Message */}
            <p className="text-sm text-cyan-400">{result}</p>
          </form>
        </div>
      </div>
    </section>
