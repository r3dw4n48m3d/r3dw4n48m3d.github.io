  ...
  const achievements = [
    {
      ...
      description: 'Ranked in the top 100 on CTFtime.org with consistent performance across multiple international competitions.',
    ...
    },
    {
      ...
      description: 'Recognized in multiple bug bounty programs for discovering critical security vulnerabilities.',
      tags: ['Bug Bounty', 'Recognition', 'Security'],
    },
    {
      title: 'Cybersecurity Speaker',
      image: 'https://images.unsplash.com/photo-1475721027785-f74eccf877e2?w=400&h=300&fit=crop',
      description: 'Featured speaker at cybersecurity conferences and webinars, sharing knowledge on offensive security.',
    ...
    },
    {
      ...
      description: 'Active contributor to security tools and frameworks used by the pentesting community.',
      tags: ['Open Source', 'Tools', 'Community'],
    },
    {
      title: 'HackTheBox Pro Hacker',
      image: 'https://images.unsplash.com/photo-1526374965328-7f61d4dc18c5?w=400&h=300&fit=crop',
      description: 'Achieved Pro Hacker rank on HackTheBox platform with 50+ machines pwned.',
      tags: ['HackTheBox', 'Pro Hacker', 'Labs'],
    },
    {
      title: 'Security Research Publication',
      image: 'https://images.unsplash.com/photo-1507003211169-0a1dd7228f2d?w=400&h=300&fit=crop',
      description: 'Published security research papers on novel attack vectors and defense mechanisms.',
    ...
    <section id="achievements" className="py-20 px-4 bg-green-950/10">
      <div className="max-w-6xl mx-auto">
        <div className="text-center mb-16">
          ...
          <p className="text-green-600 mt-4">// Milestones and recognitions in my security journey</p>
        </div>
