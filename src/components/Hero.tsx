...
export default function Hero() {
  ...
  const fullText = 'Offensive Security · Penetration Testing · Red Team';
    ...
    <section id="home" className="min-h-screen flex items-center justify-center pt-16 px-4">
      <div className="max-w-5xl mx-auto text-center">
        ...
        <p className="text-green-600 text-lg md:text-xl max-w-3xl mx-auto mb-8 leading-relaxed">
          <span className="text-cyan-400">&gt;</span> Helping you find vulnerabilities before attackers do.
        </p>

        <p className="text-green-500/80 max-w-2xl mx-auto mb-12">
          Junior Penetration Tester specializing in web and network security, Active Directory assessments, 
          and realistic adversary-style attack simulations.
        </p>
          ...
          <div className="animate-scroll whitespace-nowrap">
            {[...Array(2)].map((_, i) => (
              <span key={i} className="inline-block">
                <span className="text-cyan-400 mx-8">⚡ Certified Offensive Security</span>
                <span className="text-green-400 mx-8">∞ Always Learning</span>
                <span className="text-cyan-400 mx-8">🔐 AD Domain Dominance</span>
                <span className="text-green-400 mx-8">🎯 Building Red Team Career</span>
              </span>
            ))}
          </div>
        </div>
