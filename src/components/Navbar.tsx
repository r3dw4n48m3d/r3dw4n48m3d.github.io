        ...
        <div className="flex items-center justify-between h-16">
          ...
          >
            ...
            <span className="text-green-400 font-bold tracking-wider">
              0x<span className="text-cyan-400">R3DW4N</span>
            </span>
          </Link>
          ...
          <div className="hidden md:flex items-center gap-1">
            {navItems.map((item) => (
              ...
              >
                {item.label}
                <span
                  className={`absolute bottom-0 left-0 w-full h-0.5 bg-cyan-400 transform origin-left transition-transform duration-300 ${
                    activeSection === item.id
                      ? "scale-x-100"
