      ...
      <div className="max-w-6xl mx-auto">
        <div className="text-center mb-16">
          <h2 className="text-3xl md:text-4xl font-bold mb-4">
            ...
            <span className="text-cyan-400">Write-Ups</span>
            <span className="text-green-500">/&gt;</span>
          </h2>
          ...
          <p className="text-green-600 mt-4">
            Sharing knowledge and security insights
          </p>
        </div>
        {/* Speaking Events
        <div className="mb-16">
                  ...
                  <div className="flex-1">
                    ...
                    <ul className="space-y-1">
                      {event.points.map((point, i) => (
                        <li
                          key={i}
                          className="text-sm text-green-500 flex items-start gap-2"
                        >
            ...
            {blogPosts.map((post, index) => (
              ...
              >
                ...
                <div className="flex items-center gap-2 px-4 py-2 bg-green-900/20 border-b border-green-900/50">
                  ...
                  <span className="text-green-600 text-xs font-mono ml-2">
                ...
                <div className="p-4">
                  ...
                  <p className="text-green-600 text-sm mb-3 line-clamp-2">
                    {post.description}
                  </p>
